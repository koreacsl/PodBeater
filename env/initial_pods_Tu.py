...
# ====================================================================================================================================================================================
# Initial Pod Manifest Generator Script for Kubernetes Cluster
#
# Instruction:
...
for service, config in services.items():
    for i in range(N):
        pod_name = f"{service}-initial-pod-{i + 1}"

        pod_affinity = generate_random_pod_affinity(service, pod_affinity_data, preferred_count=2, required_count=2)
    ...
    print(f"{N} {service} Initial Pod manifests for each service were created in the {output_dir} directory.")
